...
// get the result of currrent attempt question
function getResult(element){
     ...
     if(id === currentQuestion.answer){
         ...
         // add the indicator to correct marks
         ...
         // add the indicator to incorrect marks
...
// make all the option unclickable once the user select a option (RESTRICT THE USER TO CHANGE THE OPTION AGAIN)
...
function startQuiz() {
    ...
    // first we will set all question in availbleQuestions Array
